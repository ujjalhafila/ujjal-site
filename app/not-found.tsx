  ...
  return (
    <main style={{ minHeight:"100vh", display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", padding:"6rem 2.5rem", textAlign:"center" }}>
        <div style={{ fontFamily:S.serif, fontSize:"clamp(6rem,15vw,12rem)", fontWeight:900, lineHeight:1, color:"transparent", WebkitTextStroke:"1px rgba(15,14,13,0.15)", marginBottom:"2rem", userSelect:"none" }}>
          404
        </div>
        <h1 style={{ fontFamily:S.serif, fontSize:"clamp(1.5rem,3vw,2.5rem)", fontWeight:700, letterSpacing:"-0.02em", marginBottom:"1rem" }}>
          Nothing here — yet.
        </h1>
