  ...
  return (
    <main>
      ...
      <div style={{ paddingTop:"5rem" }}>
        ...
        <div style={{ padding:"3rem 2rem 2.5rem", borderBottom:"1px solid var(--border)" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"3rem", alignItems:"start" }} className="work-detail-header">
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"1rem" }}>
              ...
              {item.url && (
                <a href={item.url} target="_blank" rel="noopener" style={{ fontFamily:S.mono, fontSize:"12px", letterSpacing:"0.08em", textTransform:"uppercase", color:"var(--accent)", textDecoration:"none", borderBottom:"1px solid var(--accent)", paddingBottom:"2px", width:"fit-content" }}>
                  View project ↗
                </a>
              )}
            </div>
        ...
        {/* Content — full width, centred, no blank sidebar */}
